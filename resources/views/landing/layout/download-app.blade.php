        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <figure>
                            <img src="{{ url('/assets') }}/images/device.png" alt="phone" class="single-image">
                        </figure>
                    </div>
                    ...
                    <div class="col-md-7">
                        <div class="app-info">
                            ...
                            <div class="google-app">
                                <img src="{{ url('/assets') }}/images/google-play.jpg" alt="google play">
                                <img src="{{ url('/assets') }}/images/app-store.jpg" alt="app store">
                            </div>
                        </div>
                    </div>
