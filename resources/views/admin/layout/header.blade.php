        ...
        <div class="d-flex align-items-center">
            ...
            <div class="responsive-logo">
                <a href="index.html" class="header-logo">
                    <img src="{{ url('/admin') }}/images/brand/logo-3.png" class="mobile-logo logo-1" alt="logo">
                    <img src="{{ url('/admin') }}/images/brand/logo.png" class="mobile-logo dark-logo-1" alt="logo">
                </a>
            </div>
            <!-- sidebar-toggle-->
            <a class="logo-horizontal " href="index.html">
                <img src="{{ url('/admin') }}/images/brand/logo.png" class="header-brand-img desktop-logo"
                    alt="logo">
                        ...
                        <div class="d-flex order-lg-2">
                                    ...
                                    <div class="message-menu">
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ url('/admin') }}/images/users/1.jpg"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ url('/admin') }}/images/users/12.jpg"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ url('/admin') }}/images/users/4.jpg"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ url('/admin') }}/images/users/15.jpg"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                            ...
                            <div class="dropdown d-md-flex profile-1">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown"
                                    ...
                                    <span>
                                        <img src="{{ url('/admin') }}/images/users/8.jpg" alt="profile-user"
