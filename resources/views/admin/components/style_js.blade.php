 <!-- Libs JS -->
 <script src="{{ url('/admin') }}/libs/apexchart{{ url('/admin') }}/apexcharts.min.js?1692870487" defer></script>
 <script src="{{ url('/admin') }}/libs/jsvectorma{{ url('/admin') }}/js/jsvectormap.min.js?1692870487" defer></script>
 <script src="{{ url('/admin') }}/libs/jsvectorma{{ url('/admin') }}/maps/world.js?1692870487" defer></script>
 <script src="{{ url('/admin') }}/libs/jsvectorma{{ url('/admin') }}/maps/world-merc.js?1692870487" defer></script>
 <!-- Tabler Core -->
