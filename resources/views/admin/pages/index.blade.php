                        ...
                        <table id="data-table" class="table table-bordered text-nowrap mb-0">
                            ...
                            <tbody>
                                <tr class="border-bottom">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <span class="avatar avatar-md brround mt-1"
                                                style="background-image: url({{ url('/admin') }}/images/users/11.jpg)"></span>
                                    ...
                                    <td class="">
                                        <a class="btn btn-primary btn-sm rounded-11 me-2" data-bs-toggle="tooltip"
                                ...
                                <tr class="border-bottom">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <span class="avatar avatar-md brround mt-1"
                                                style="background-image: url({{ url('/admin') }}/images/users/1.jpg)"></span>
                                            <div class="ms-2 mt-0 mt-sm-2 d-block">
                                                <h6 class="mb-0 fs-14 fw-semibold">Virginia Gray
                                                </h6>
                                ...
                                <tr class="border-bottom">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <span class="avatar avatar-md brround mt-1"
                                                style="background-image: url({{ url('/admin') }}/images/users/12.jpg)"></span>
                                            <div class="ms-2 mt-0 mt-sm-2 d-block">
                                                <h6 class="mb-0 fs-14 fw-semibold">Jacob Thomson
                                                </h6>
                                ...
                                <tr class="border-bottom">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <span class="avatar avatar-md brround mt-1"
                                                style="background-image: url({{ url('/admin') }}/images/users/13.jpg)"></span>
                                            <div class="ms-2 mt-0 mt-sm-2 d-block">
                                                <h6 class="mb-0 fs-14 fw-semibold">Trevor Thomson
                                                </h6>
                                ...
                                <tr class="border-bottom">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <span class="avatar avatar-md brround mt-1"
                                                style="background-image: url({{ url('/admin') }}/images/users/2.jpg)"></span>
                                            <div class="ms-2 mt-0 mt-sm-2 d-block">
                                                <h6 class="mb-0 fs-14 fw-semibold">Kylie north
                                                </h6>
                                ...
                                <tr class="border-bottom">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <span class="avatar avatar-md brround mt-1"
                                                style="background-image: url({{ url('/admin') }}/images/users/14.jpg)"></span>
                                            <div class="ms-2 mt-0 mt-sm-2 d-block">
                                ...
                                <tr class="border-bottom">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <span class="avatar avatar-md brround mt-1"
                                                style="background-image: url({{ url('/admin') }}/images/users/4.jpg)"></span>
                                            <div class="ms-2 mt-0 mt-sm-2 d-block">
                                                <h6 class="mb-0 fs-14 fw-semibold">Trevor Thomson
                                                </h6>
                                                <span class="fs-12 text-muted">trevor@gmail.com</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <span class="avatar avatar-md brround mt-1"
                                                style="background-image: url({{ url('/admin') }}/images/users/5.jpg)"></span>
                                            <div class="ms-2 mt-0 mt-sm-2 d-block">
                                                <h6 class="mb-0 fs-14 fw-semibold">Emily Lewis
                                                </h6>
